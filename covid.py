...
dataset_path = 'C://covid19/dataset'


covid_19_path = "C://covid19/covid-chest-xray"
pneumonia_dataset_path ='C://covid19/chest-xray-pneumonia/chest_xray'

eda = pd.read_csv('C://covid19/covid-chest-xray/metadata.csv')
...
model.save('C://covid19/covid19_xray.h5')
...
new_dataset ='E:/project/payan/covid19/COVID-19_Radiography_Dataset'
...
new_imag2 = cv2.imread('C://covid19/COVID-19_Radiography_Dataset/Viral Pneumonia/Viral Pneumonia-2.png')
